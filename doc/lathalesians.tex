...
Here is an example of how you can include the indices in your document. Notice that, for the indices to work, you need the package \program{imakeidx}.
\begin{snippet}{LaTeX}
...
\end{snippet}
The \code{<authorsurname>} is the surname of the first author in lower case and without any spaces, dashes, \etc, \eg: \code{edalat}, \code{vanmill}. The \code{year} is in the \code{yyyy} format, \eg 2017. The number is included only when there is a clash, thus we have \code{edalat-1998}, \code{edalat-1998-1}, and \code{edalat-1998-2}.
...
\input{lathalesians-nomenclature-analysis}
\input{lathalesians-nomenclature-linear}
\input{lathalesians-nomenclature-probability}
