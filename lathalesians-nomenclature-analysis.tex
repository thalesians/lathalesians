...
\nomenclature[a0380]{$\collection{O\in\Collection{T}}[O\text{ clopen}]$}{\dittostraight}
\nomenclature[a0390]{$\set{1,2,3}$}{definition of a set}
\nomenclature[a0400]{$\set{x\in\N}[x\text{ even}]$}{\dittostraight}
\nomenclature[a0410]{$\seqel{a_k}$}{name of element of a sequence}
\nomenclature[a0420]{$\seqel{a_k}[k\in\N]$}{\dittostraight}
\nomenclature[a0430]{$\seqel{a_k}[k=1][\infty]$}{\dittostraight}
...
\nomenclature[a0590]{$\functype[f]{\C}{\Rnn}$}{\dittostraight}
\nomenclature[a0600]{$\funcdefn{x}{x^2}$}{function definition}
\nomenclature[a0610]{$\funcdefn[f]{x}{x^2}$}{\dittostraight}
